...
class StudentManager:
    ...
    def search_student(self,id):
        ...
        cursor.execute('SELECT * FROM students WHERE id = ?'(id)) # Find the student who has this id number 
    ...
    def update_student(self,id,name,age,grade,email): # getting the id for queering the student we want to update info of 
        conn = get_connection()
        cursor = conn.cursor()
